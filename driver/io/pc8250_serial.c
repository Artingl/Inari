...
static int port_index[] = { [ COM1 ] = 0, [ COM2 ] = 1, [ COM3 ] = 2, [ COM4 ] = 3, [ COM5 ] = 4, [ COM6 ] = 5, [ COM7 ] = 6, [ COM8 ] = 7, };
static int port_value[] = { COM1, COM2, COM3, COM4, COM5, COM6, COM7, COM8, };
...
{
    if (console_is_early || !serial_is_initialized) return IRQ_HANDLED;
...
static int pc8250_serial_init()
{
    ...
    console_port = COM1;
    if (strcmp(device, "COM2") == 0) console_port = COM2;
    if (strcmp(device, "COM3") == 0) console_port = COM3;
    if (strcmp(device, "COM4") == 0) console_port = COM4;
    if (strcmp(device, "COM5") == 0) console_port = COM5;
    if (strcmp(device, "COM6") == 0) console_port = COM6;
    if (strcmp(device, "COM7") == 0) console_port = COM7;
    if (strcmp(device, "COM8") == 0) console_port = COM8;
