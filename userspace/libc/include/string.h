...
/* =========================
   Character helpers
   ========================= */
static inline char k_toupper(char c) { return (c >= 'a' && c <= 'z') ? c - 0x20 : c; }
...
static inline void *memove(void *restrict dest, const void *restrict src, size_t n) {
    volatile unsigned char *d = dest;
    const unsigned char *s = src;
    while (n--)
        *d++ = *s++;
