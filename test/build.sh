...
$LD --entry=__start -no-pie -nostdlib -o main.exe -m i386pe main.o -L../libc -lc --image-base 0x00800000


$CC $(cat /home/artingl/dev/inari/cflags.txt) -I ../libc/include/ -c test.c -o test.o -fleading-underscore
$LD --entry=__start -no-pie -nostdlib -o test.exe -m i386pe test.o -L../libc -lc --image-base 0x00800000
