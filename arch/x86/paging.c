...
static inline struct paging_directory *__get_pagedir(void)
{
    uintptr_t cr3;
...
static inline void *__alloc_table(size_t offset)
{
    struct paging_directory *dir = __get_pagedir();
