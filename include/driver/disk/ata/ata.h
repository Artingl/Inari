...
#define ATA_ERR                                                                                                        \
    0x01 // R 	Error Register 	                  Used to retrieve any error generated by the last ATA command executed.
         // 8-bit / 16-bit
#define ATA_FEAT                                                                                                       \
    0x01 // W 	Features Register 	              Used to control command specific interface features. 8-bit / 16-bit
#define ATA_SECTOR_CNT                                                                                                 \
    0x02 // R/W 	Sector Count Register 	          Number of sectors to read/write (0 is a special value). 8-bit /
         // 16-bit
...
#define ATA_ALTERNATE_STATUS                                                                                           \
    0x00 // R 	Alternate Status Register 	      A duplicate of the Status Register which does not affect interrupts.
         // 8-bit / 8-bit
#define ATA_ALTERNATE_DEVICE_CONTROL                                                                                   \
    0x00 // W 	Device Control Register 	      Used to reset the bus or enable/disable interrupts. 8-bit / 8-bit
#define ATA_ALTERNATE_DRIVE_ADDRESS                                                                                    \
